...
export default function BandagisteDashboardPage() {
            ...
            <CardContent>
              <div className="space-y-6">
                <div className="p-4 border rounded-lg">
                  <h3 className="font-semibold mb-2">Gestion des demandes</h3>
                  <p className="text-sm text-neutral-600 mb-3">
                    Recevez et gérez automatiquement les demandes de devis des ergothérapeutes
                  </p>
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-neutral-600 mb-3">
                    Suivez l'avancement de vos projets d'adaptation en temps réel
                  </p>
                  <Badge variant="outline">Bientôt disponible</Badge>
                </div>
